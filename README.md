...
1. Download and install [Hugo version v0.111.3](https://github.com/gohugoio/hugo/releases/tag/v0.111.3). Installation instructions for different operating systems are available in the [Hugo documentation library](https://gohugo.io/getting-started/installing/).
